    ...
    return Form(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(16, 52, 16, 12),
              child: Row(
                mainAxisSize: MainAxisSize.max,
                                      ...
                                      children: [
                                        Expanded(
                                          child: SwitchListTile(
                                            ...
                                            tileColor: Color(0xE7FFFFFF),
                                            activeColor: Color(0xFFEF5E5E),
                                            activeTrackColor: Color(0xE7FFFFFF),
                                            dense: true,
                                            controlAffinity:
